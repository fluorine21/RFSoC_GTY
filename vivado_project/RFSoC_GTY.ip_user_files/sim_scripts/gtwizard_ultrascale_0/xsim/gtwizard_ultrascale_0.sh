...
# Set xvlog options
xvlog_opts="--incr --relax -L axi_vip_v1_1_11 -L zynq_ultra_ps_e_vip_v1_0_11 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L gtwizard_ultrascale_v1_7_12 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gtwizard_ultrascale_0 xil_defaultlib.gtwizard_ultrascale_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gtwizard_ultrascale_0 -key {Behavioral:sim_1:Functional:gtwizard_ultrascale_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2696.protoinst" -protoinst "protoinst_files/bd_e6c7.protoinst" -protoinst "protoinst_files/top_level_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gtwizard_ultrascale_0.wdb xsim.dir)
